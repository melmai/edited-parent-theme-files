...
function factorycommercegurus_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => 'https://files.commercegurus.com/layersliderwp-6.8.4.installable.zip', // The plugin source
			'required'           => false, // If false, the plugin is only 'recommended' instead of required
			'version'            => '6.8.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
		...
		array(
			...
			'source'             => 'https://files.commercegurus.com/js_composer_6.0.2/js_composer.zip', // The plugin source
			'required'           => false, // If false, the plugin is only 'recommended' instead of required
...
function cg_import_files() {
	return array(
		array(
			...
			'import_file_url'          => 'https://files.commercegurus.com/factory-demodata/factory-content.xml',
			'import_widget_file_url'   => 'https://files.commercegurus.com/factory-demodata/factory-widgets.wie',
...
if ( class_exists( 'WPBakeryVisualComposerAbstract' ) ) {
	...
	add_action(
		'vc_after_mapping', function() {
			if ( is_admin() ) {
				$_COOKIE['vchideactivationmsg_vc11'] = 30;
			} }
	);
}
...
// use get_theme_file_path() to override this file in child theme
